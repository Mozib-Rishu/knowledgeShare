        ...
        <div class="col col-lg-4 py-4">
            <div class="card" style="width: 25rem; height: 30rem;">
                    <div class="card-body">
                        ...
                        <p class="card-text">Some quick example texsldkfjsljfajdlksjfkldsjfa;fdallf;dshkjfhskdjhsjhsdkjshkjfhsdjhfsjkhfjshkjhkdshjfhsjhsjfhskhdfjhjhkjshldkshkhdkfksdjkjkt to build on the card title and make up the bulk of the card's content.</p>
...
<div class="card text-primary border-primary" style="width: 25rem; border: 1px;">
        ...
        <div class="card" style="width: 50rem">
            <img class="card-img-top img-fluid" src="//placehold.it/200x230" alt="Card image cap">
            <div class="card-body">
                <h4 class="card-title">Card title</h4>
        ...
        <div class="card">
            <img class="card-img-top img-fluid" src="//placehold.it/200x220" alt="Card image cap">
            <div class="card-body">
                <h4 class="card-title">Card title</h4>
                <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.</p>
                <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
